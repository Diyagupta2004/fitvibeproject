...
router.post('/simulate-payment', authenticateToken, validatePayment, async (req, res) => {
    try {
        ...
        const paymentQuery = `
            INSERT INTO payments (user_id, subscription_plan, amount, payment_method, status, created_at)
...
router.get('/history', authenticateToken, async (req, res) => {
    try {
        ...
        const paymentsQuery = `
            SELECT id, subscription_plan, amount, payment_method, status, created_at
            FROM payments 
            WHERE user_id = ? 
